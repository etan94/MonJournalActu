...
# --- 1. CHARGEMENT INTELLIGENT DES SECRETS ---
# Essaie de charger .env (pour Pydroid), sinon utilise les variables d'env (pour GitHub)
try:
...
def get_last_ids():
    """Lit le fichier de mémoire. Crée le fichier s'il n'existe pas."""
